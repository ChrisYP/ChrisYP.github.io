...
### Reasons for "Join Failed" (Error `10008`)

1. The group does not allow accounts created through low-quality registrations. This is typically determined during the account registration phase.
2. The captcha verification score may fall below Discord’s set threshold. While the interface is generally workable, this possibility can be ruled out in most cases.
